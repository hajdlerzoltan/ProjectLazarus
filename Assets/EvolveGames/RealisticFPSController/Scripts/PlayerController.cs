...
namespace EvolveGames
{
    ...
    public class PlayerController : NetworkBehaviour
    {
        ...
        [SerializeField] public Transform camInstance;
		...
		public override void OnNetworkSpawn()
        {
            ...
            camInstance.AddComponent<Camera>();
			InstallFOV = camInstance.GetComponent<Camera>().fieldOfView;
			camInstance.AddComponent<HeadBob>();
            player = GameObject.Find("PlayerStats");
            //playerName.text = player.GetComponent<PlayerStats>().playername.Value;
